          ...
          <div id='sobremi' className="flex-container">
            ...
            <div className="flex-items">
              <div className='sobremi'>
                  <h3>About me</h3>
                  <p>I'm a systems engineering student, looking for a job. I'm learning Front-End development, and every day I keep looking to improve my code skills as well as interpersonal skills. I am committed and seek to improve in everything I do.</p>
              </div>
